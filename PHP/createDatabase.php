...
CREATE TABLE users(id varchar(31) PRIMARY KEY, name varchar(255), password varchar (255), email varchar (255), popularMemes int (31), earnings double (15,2), admin int(2), bankingID varchar (255), fileType varchar (8));
INSERT INTO users VALUES ("0nqjdr90iqi", 'Nathan', "9315", "nateroskelley@gmail.com",0,0,1,"","","");

CREATE TABLE memes( id VARCHAR(31) PRIMARY KEY, title varchar(255), pointerID varchar (31), likes int(15),
