...
CREATE TABLE memes( id VARCHAR(31) PRIMARY KEY, title varchar(511), pointerID varchar (31), likes int(15),
tags varchar (511), description varchar (255), filetype varchar (8), isPrivate tinyint, age DATETIME(255));
